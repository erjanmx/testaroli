...
[![Go Reference](https://pkg.go.dev/badge/github.com/grubbydistr/testaroli.svg)](https://pkg.go.dev/github.com/grubbydistr/testaroli)
[![Go Report Card](https://goreportcard.com/badge/github.com/grubbydistr/testaroli)](https://goreportcard.com/report/github.com/grubbydistr/testaroli)
![Tests](https://github.com/grubbydistr/testaroli/actions/workflows/go.yml/badge.svg)
![CodeQL](https://github.com/grubbydistr/testaroli/workflows/CodeQL/badge.svg)
...
Typical use:
```go
import . "github.com/grubbydistr/testaroli"
...
```
See more advanced usage examples in [examples](../examples) directory. For detailed documentaion see [Go reference](https://pkg.go.dev/github.com/grubbydistr/testaroli).
